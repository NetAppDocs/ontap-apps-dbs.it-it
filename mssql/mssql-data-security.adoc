...
[role="lead"]
La protezione di un ambiente di database è un impegno multidimensionale che va oltre la gestione del database stesso. NetApp offre diverse funzioni esclusive progettate per proteggere gli aspetti dello storage dell'infrastruttura di database.
