...
L'allineamento negli ambienti Solaris è più complesso. Consulta  https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_identify_unaligned_IO_on_LUNs["Come identificare gli IO non allineati sulle LUN"] per maggiori informazioni.
