...
summary: Oracle,SM-as,Active Sync,mediatore 
searchtitle: Oracle, SnapMirror Active Sync e ONTAP Mediator 
---
= Mediatore ONTAP
:allow-uri-read: 
:imagesdir: ../media/
...
image:smas-mediator.png["Diagramma di sincronizzazione attivo SnapMirror con mediatore"]
