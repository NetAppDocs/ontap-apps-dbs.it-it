...
Le prestazioni di NFS su Linux dipendono da un parametro chiamato `tcp_max_slot_table_entries`. Consultare la link:../../common/storage-configuration/nfs.html["NFS"] per informazioni critiche.
