...
[NOTE]
====
* Nei database Oracle, NVFAIL deve essere abilitato su tutte le LUN che ospitano componenti critici (datafile, redo log, control file).
* Sui sistemi AFF, NVFAIL opera a livello di volume e si applica a tutti i dati contenuti.
* Su ASA, NVFAIL opera a livello di LUN o namespace.
