...
[role="lead"]
Il principale valore di ONTAP in un ambiente database Oracle deriva dalle tecnologie di base di ONTAP, come le copie Snapshot istantanee, la semplice replica SnapMirror e la creazione efficiente di volumi, LUN e namespace clonati.
