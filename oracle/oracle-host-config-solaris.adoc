...
. Partiziona le LUN e verifica che siano allineate correttamente. Consulta link:oracle-notes-wafl-alignment-verification.html["Allineamento WAFL"] per le istruzioni su come testare e confermare direttamente l'allineamento.
