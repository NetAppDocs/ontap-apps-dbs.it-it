...
summary: Configurazione stripe LVM per database Oracle con ASA r2 
searchtitle: Striping LVM con database Oracle su ASA r2 
---
= Striping LVM
:hardbreaks:
:allow-uri-read: 
...
* Dimensione stripe ≥ dimensione blocco database.
* Dimensione stripe * numero di LUN ≈ 1 MB per un parallelismo ottimale.
