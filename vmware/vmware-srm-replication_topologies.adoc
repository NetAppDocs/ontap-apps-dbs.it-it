...
https://docs.netapp.com/us-en/ontap/snapmirror-active-sync/["Scopri di più sulla sincronizzazione attiva ONTAP SnapMirror"]
...
Per le informazioni più recenti su SnapMirror e SnapVault per ONTAP 9, vedere https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["Guida alle Best practice per la configurazione di SnapMirror TR-4015 per ONTAP 9."^]
