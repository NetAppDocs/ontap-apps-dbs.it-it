...
| Site Recovery Manager | Sì | Sì | No ^2^ | V3 solo ^2^ 
...
| Indirizzo IP | VMkernel | No ^4^ | No ^4^ | Sì 


| Aggregazione dei collegamenti | Switch virtuale | Sì | Sì | No ^3^ 


| VLAN | Gruppi di porte VMkernel e VM | Sì | Sì | No ^3^ 


| Controllo di flusso | NIC | Sì | Sì | No ^3^ 


| Spanning tree | No | Sì | No | No 


| MTU (per frame jumbo) | Switch virtuale e porta VMkernel (9000) | Sì (impostato su max) | Sì (9000) | No ^3^ 
