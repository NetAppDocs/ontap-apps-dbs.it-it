...
** VMware supporta nconnect con NFSv3 a partire da vSphere 8.0U2. Ulteriori informazioni su nconnect sono disponibili link:vmware-vsphere-network.html#nfs["qui"].
